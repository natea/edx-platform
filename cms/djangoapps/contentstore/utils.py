...
def add_instructor_in_course(course_id, requesting_user, new_instructor):
    """
...
def initialize_permissions_in_new_course(course_id, user_who_created_course):
    """
...
def remove_all_instructors_from_course(course_id):
    """
...
def delete_course_and_groups(course_id, user_id):
    ...
    with module_store.bulk_write_operations(course_id):
        ...
        try:
            remove_all_instructors_from_course(course_id)
